...
public class Main {
	...
	public static void main(String[] args) {
		...
		ToricPosition tp1 = new ToricPosition(10.0, 50.0);
		ToricPosition tp2 = new ToricPosition(800.0, 900.0);
		Vec2d vec2d = new Vec2d(800.0, 800.0);
		System.out.println(tp1.add(vec2d));
		System.out.println(tp1.add(tp2));
